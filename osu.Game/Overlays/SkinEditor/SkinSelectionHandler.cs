...
namespace osu.Game.Overlays.SkinEditor
{
    public partial class SkinSelectionHandler : SelectionHandler<ISerialisableDrawable>
    {
        ...
        public override SelectionScaleHandler CreateScaleHandler()
        {
            ...
            scaleHandler.PerformFlipFromScaleHandles += a => TransformSelectionBox.PerformFlipFromScaleHandles(a);
        ...
        protected override void OnSelectionChanged()
        {
            ...
            TransformSelectionBox.CanFlipX = true;
            TransformSelectionBox.CanFlipY = true;
            TransformSelectionBox.CanReverse = false;
        }
